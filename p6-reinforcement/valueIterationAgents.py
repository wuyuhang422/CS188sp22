...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for _ in range(self.iterations):
            ...
            for state in self.states:
                next_action = self.computeActionFromValues(state)
                if next_action:
                    new_values[state] = self.computeQValueFromValues(state, next_action)
    ...
    def computeActionFromValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        lst = self.mdp.getPossibleActions(state)
        mx = -float("inf")
        res = None
        for action in lst:
